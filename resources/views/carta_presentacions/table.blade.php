            ...
            <td>
                ...
                <div class='btn-group'>
                  <a href="{{ route('formatos.presentacion', ['idProyecto' => $cartaPresentacion->id])}}" target="_blank" class='btn btn-labeled btn-info btn-sm'><i class="fa fa-print"></i></a>
                    <a href="{!! route('cartaPresentacions.show', [$cartaPresentacion->id]) !!}" class='btn btn-labeled btn-success btn-sm'><i class="fa fa-eye"></i></a>
                    <a href="{!! route('cartaPresentacions.edit', [$cartaPresentacion->id]) !!}" class='btn btn-labeled btn-warning btn-sm'><i class="fa fa-pencil"></i></a>
