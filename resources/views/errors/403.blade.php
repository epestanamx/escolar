...
<html>
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="message-box">
                            ...
                            <h6>No tienes autorización para realizar la acción solicitada.</h6>
                            <div class="buttons-con">
                                <div class="action-link-wrap">
                                    <a href="{{ url('/home') }}" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">Ir a la página principal</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{ asset('js/popper.min.js') }}"></script><!-- Popper for Bootstrap --><!-- Tether for Bootstrap -->
