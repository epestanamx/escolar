...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title"><b>Modificar perfil de usuario</b></h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="p-20">
                            <form class="form-horizontal" action="{{ route('entrust-gui::roles.update', $model->id) }}" method="post" role="form">
